  ...
  outputs =
    ...
    flake-utils.lib.eachDefaultSystem (
      ...
      let
        ...
        src = pkgs.lib.cleanSourceWith {
          src = ./.;
          filter =
            path: type: (baseNameOf (toString path) == "README.md") || (craneLib.filterCargoSources path type);
          name = "source";
        };
    ...
    // {
      overlays.default = final: prev: {
        wardex = self.packages.${prev.stdenv.hostPlatform.system}.default;
      };
